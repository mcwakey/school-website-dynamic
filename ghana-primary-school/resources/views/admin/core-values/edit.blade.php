        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Core Value</h3>
                ...
                <form action="{{ route('admin.core-values.update', $coreValue) }}" method="POST">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') is-invalid @enderror"
                                           id="title" name="title" value="{{ old('title', $coreValue->title) }}" required>
                                    @error('title')
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('icon') is-invalid @enderror"
                                           id="icon" name="icon" value="{{ old('icon', $coreValue->icon) }}" required>
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="color" class="form-control @error('color') is-invalid @enderror"
                                           id="color" name="color" value="{{ old('color', $coreValue->color) }}">
                                    @error('color')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      id="description" name="description" rows="4" required>{{ old('description', $coreValue->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('sort_order') is-invalid @enderror"
                                           id="sort_order" name="sort_order" value="{{ old('sort_order', $coreValue->sort_order) }}">
                                    @error('sort_order')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="border rounded p-3">
                                <div class="text-center">
                                    <div id="icon-preview" style="color: {{ $coreValue->color }}; font-size: 48px;">
                                        <i class="{{ $coreValue->icon }}"></i>
                                    </div>
                                    <h5 id="title-preview" class="mt-2">{{ $coreValue->title }}</h5>
                                    <p id="description-preview" class="text-muted">{{ $coreValue->description }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Update Core Value
                        </button>
